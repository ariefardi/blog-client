  ...
  methods: {
      getOneArticle () {
        ...
        .then(({data})=> {
            ...
            this.title = this.pageArticle.title
            this.content = this.pageArticle.content
            this.realContent = this.pageArticle.realContent
            this.author = localStorage.getItem('username')
            this.category = this.pageArticle.category
